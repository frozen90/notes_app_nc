    ...
    return (
        <Card className='note-bg'>
            ...
            <Card.Content textAlign='left' className='note-content'>
                <TextareaAutosize ref={textAreaRef} onDoubleClick={()=>{setEditable(true)}} value={value} onChange={handleTextChange} maxRows={8} className='remove-bg note-textarea' readOnly={!editable}/>
            </Card.Content>
            <Card.Content extra>
